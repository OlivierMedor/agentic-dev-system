# Local Model Scorecard Prompt: Developer Agent
...
Given the function below, identify the bug and propose a minimal patch in prose. Do not write or apply files.
