...
`story_025_remote_dev_status_integration` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_025_remote_dev_status_integration/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_025_remote_dev_status_integration
docker compose run --rm dev agentic quality-gate --story story_025_remote_dev_status_integration
```
