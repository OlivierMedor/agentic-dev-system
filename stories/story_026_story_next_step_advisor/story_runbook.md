...
`story_026_story_next_step_advisor` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_026_story_next_step_advisor/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_026_story_next_step_advisor
docker compose run --rm dev agentic quality-gate --story story_026_story_next_step_advisor
```
