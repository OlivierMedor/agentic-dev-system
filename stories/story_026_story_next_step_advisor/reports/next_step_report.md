...
agentic cloud-review-packet --story story_026_story_next_step_advisor
...
- reports: developer_report.md, finalize_story_report.md, finalize_story_result.yaml, local_review_report.md, next_step_report.md, prepare_story_report.md, quality_gate_report.md, quality_gate_result.yaml, test_layer_report.md, test_layer_result.yaml, test_report.md
