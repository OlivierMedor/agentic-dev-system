...
`story_030_workflow_run_prepare_phase` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_030_workflow_run_prepare_phase/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_030_workflow_run_prepare_phase
docker compose run --rm dev agentic quality-gate --story story_030_workflow_run_prepare_phase
```
