...
`story_046_local_agent_empty_response_guard` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_046_local_agent_empty_response_guard/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_046_local_agent_empty_response_guard
docker compose run --rm dev agentic quality-gate --story story_046_local_agent_empty_response_guard
```
