...
`story_038_public_metadata_release_readiness` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_038_public_metadata_release_readiness/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_038_public_metadata_release_readiness
docker compose run --rm dev agentic quality-gate --story story_038_public_metadata_release_readiness
```
