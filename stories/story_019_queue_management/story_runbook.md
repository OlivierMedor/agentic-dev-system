...
`story_019_queue_management` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_019_queue_management/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_019_queue_management
docker compose run --rm dev agentic quality-gate --story story_019_queue_management
```
