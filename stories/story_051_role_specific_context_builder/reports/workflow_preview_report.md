...
- reports/micro_readiness_report.md
- reports/micro_readiness_result.yaml
- reports/prepare_story_report.md
- reports/quality_gate_report.md
- reports/quality_gate_result.yaml
- reports/role_context
- reports/role_context_report.md
- reports/role_context_result.yaml
...
- reports: developer_report.md, finalize_story_report.md, finalize_story_result.yaml, local_review_report.md, micro_readiness_report.md, micro_readiness_result.yaml, prepare_story_report.md, quality_gate_report.md, quality_gate_result.yaml, role_context, role_context_report.md, role_context_result.yaml, test_layer_report.md, test_layer_result.yaml, test_report.md, workflow_preview_report.md, workflow_preview_result.yaml, workflow_run_report.md, workflow_run_result.yaml
...
- result files: finalize_story_result.yaml, micro_readiness_result.yaml, quality_gate_result.yaml, test_layer_result.yaml, workflow_run_result.yaml

## Recommended next action

Run workflow-run local-finalize.

## Suggested command

agentic workflow-run --story story_051_role_specific_context_builder --phase local-finalize --execute
...
- It does not execute agents through the configured agent runtime, call cloud models, call GitHub APIs, commit, push, merge, or deploy.
