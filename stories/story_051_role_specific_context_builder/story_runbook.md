...
`story_051_role_specific_context_builder` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_051_role_specific_context_builder/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_051_role_specific_context_builder
docker compose run --rm dev agentic quality-gate --story story_051_role_specific_context_builder
```
