...
`story_039_portfolio_case_study` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_039_portfolio_case_study/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_039_portfolio_case_study
docker compose run --rm dev agentic quality-gate --story story_039_portfolio_case_study
```
