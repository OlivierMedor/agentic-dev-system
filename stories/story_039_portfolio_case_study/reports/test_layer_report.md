...
- Evidence or reason: Add public documentation tests verifying the new portfolio docs exist, README links to them, the portfolio case study mentions review bundles, quality gates, LangGraph, CI/CD, and human approval, and the skills matrix mentions Python, Docker, pytest, Ruff, GitHub Actions, and LangGraph.
...
- Evidence or reason: Existing CLI and workflow tests cover command behavior; this story changes public documentation only.
