...
`story_052_codex_runtime_connector` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_052_codex_runtime_connector/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_052_codex_runtime_connector
docker compose run --rm dev agentic quality-gate --story story_052_codex_runtime_connector
```
