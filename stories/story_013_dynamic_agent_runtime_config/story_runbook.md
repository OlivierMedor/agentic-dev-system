...
`story_013_dynamic_agent_runtime_config` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_013_dynamic_agent_runtime_config/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_013_dynamic_agent_runtime_config
docker compose run --rm dev agentic quality-gate --story story_013_dynamic_agent_runtime_config
```
