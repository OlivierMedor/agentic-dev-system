...
- reports: developer_report.md, finalize_story_report.md, finalize_story_result.yaml, local_review_report.md, prepare_story_report.md, quality_gate_report.md, quality_gate_result.yaml, test_layer_report.md, test_layer_result.yaml, test_report.md, workflow_preview_report.md, workflow_preview_result.yaml
...
agentic finalize-story --story story_027_langgraph_workflow_preview
