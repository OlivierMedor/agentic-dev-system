...
`story_027_langgraph_workflow_preview` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_027_langgraph_workflow_preview/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_027_langgraph_workflow_preview
docker compose run --rm dev agentic quality-gate --story story_027_langgraph_workflow_preview
```
