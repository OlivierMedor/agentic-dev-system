...
`story_020_promote_queue_item_to_story` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_020_promote_queue_item_to_story/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_020_promote_queue_item_to_story
docker compose run --rm dev agentic quality-gate --story story_020_promote_queue_item_to_story
```
