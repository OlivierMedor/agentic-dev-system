...
`story_034_public_launch_prep` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_034_public_launch_prep/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_034_public_launch_prep
docker compose run --rm dev agentic quality-gate --story story_034_public_launch_prep
```
