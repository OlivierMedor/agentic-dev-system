...
- Evidence or reason: Add docs tests confirming docs/system_map.md and docs/public_launch_checklist.md exist, README links to required docs, and private architecture guidance is ignored and blocked by policy.
...
- Evidence or reason: Existing CLI and workflow tests cover command behavior; this story changes public documentation and repository hygiene tests.
...
- Evidence or reason: This story reads local files and does not call live external APIs.
