...
`story_040_github_templates_contributor_guide` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_040_github_templates_contributor_guide/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_040_github_templates_contributor_guide
docker compose run --rm dev agentic quality-gate --story story_040_github_templates_contributor_guide
```
