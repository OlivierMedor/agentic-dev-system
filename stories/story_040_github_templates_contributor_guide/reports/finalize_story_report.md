...
- Created or refreshed the review bundle at `/app/stories/story_040_github_templates_contributor_guide/review_bundle`.
- Ran test layer validation when `test_plan.yaml` used `test_layers_version: 1`.
- Ran the quality gate and wrote `/app/stories/story_040_github_templates_contributor_guide/reports/quality_gate_result.yaml`.
- Regenerated the review bundle after the quality gate so final evidence is captured.
- Wrote finalize result data to `/app/stories/story_040_github_templates_contributor_guide/reports/finalize_story_result.yaml`.
...
- Test layer result: /app/stories/story_040_github_templates_contributor_guide/reports/test_layer_result.yaml
