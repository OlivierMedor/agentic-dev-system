...
- Evidence or reason: Add public repository tests verifying CONTRIBUTING.md, SECURITY.md, pull request template, issue templates, README links, safety wording, validation checklist wording, and queue mapping.
...
- Evidence or reason: Existing CLI and workflow tests cover command behavior; this story changes public collaboration documentation and GitHub templates only.
