...
- Created or refreshed the review bundle at `/app/stories/story_012_agent_support_queue/review_bundle`.
- Ran the quality gate and wrote `/app/stories/story_012_agent_support_queue/reports/quality_gate_result.yaml`.
- Regenerated the review bundle after the quality gate so final evidence is captured.
- Wrote finalize result data to `/app/stories/story_012_agent_support_queue/reports/finalize_story_result.yaml`.
