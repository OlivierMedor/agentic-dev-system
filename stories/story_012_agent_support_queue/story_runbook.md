...
`story_012_agent_support_queue` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_012_agent_support_queue/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_012_agent_support_queue
docker compose run --rm dev agentic quality-gate --story story_012_agent_support_queue
```
