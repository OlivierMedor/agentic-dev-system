...
`story_016_cloud_review_result_recording` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_016_cloud_review_result_recording/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_016_cloud_review_result_recording
docker compose run --rm dev agentic quality-gate --story story_016_cloud_review_result_recording
```
