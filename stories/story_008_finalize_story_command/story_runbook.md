...
`story_008_finalize_story_command` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_008_finalize_story_command/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_008_finalize_story_command
docker compose run --rm dev agentic quality-gate --story story_008_finalize_story_command
```
