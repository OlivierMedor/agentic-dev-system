...
`story_049_micro_readiness_story_sizing` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_049_micro_readiness_story_sizing/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_049_micro_readiness_story_sizing
docker compose run --rm dev agentic quality-gate --story story_049_micro_readiness_story_sizing
```
