...
`story_037_minimal_demo_project` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_037_minimal_demo_project/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_037_minimal_demo_project
docker compose run --rm dev agentic quality-gate --story story_037_minimal_demo_project
```
