...
- Evidence or reason: Add docs and repository hygiene tests confirming demo files exist, README links the walkthrough, the demo blueprint has a stories list, no .env files exist in the demo, and the walkthrough states that no cloud models, secrets, or deployment are required.
...
- Evidence or reason: Existing CLI and workflow tests cover command behavior; this story adds documentation and a minimal sample project.
...
- Evidence or reason: This demo is local-only and does not call live external APIs.
