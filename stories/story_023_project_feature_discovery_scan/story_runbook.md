...
`story_023_project_feature_discovery_scan` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_023_project_feature_discovery_scan/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_023_project_feature_discovery_scan
docker compose run --rm dev agentic quality-gate --story story_023_project_feature_discovery_scan
```
