...
`story_031_workflow_run_cloud_review_prep` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_031_workflow_run_cloud_review_prep/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_031_workflow_run_cloud_review_prep
docker compose run --rm dev agentic quality-gate --story story_031_workflow_run_cloud_review_prep
```
