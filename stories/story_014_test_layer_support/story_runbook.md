...
`story_014_test_layer_support` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_014_test_layer_support/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_014_test_layer_support
docker compose run --rm dev agentic quality-gate --story story_014_test_layer_support
```
