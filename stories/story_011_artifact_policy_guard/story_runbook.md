...
`story_011_artifact_policy_guard` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_011_artifact_policy_guard/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_011_artifact_policy_guard
docker compose run --rm dev agentic quality-gate --story story_011_artifact_policy_guard
```
