...
- Created or refreshed the review bundle at `/app/stories/story_011_artifact_policy_guard/review_bundle`.
- Ran the quality gate and wrote `/app/stories/story_011_artifact_policy_guard/reports/quality_gate_result.yaml`.
- Regenerated the review bundle after the quality gate so final evidence is captured.
- Wrote finalize result data to `/app/stories/story_011_artifact_policy_guard/reports/finalize_story_result.yaml`.
