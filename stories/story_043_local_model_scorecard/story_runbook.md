...
`story_043_local_model_scorecard` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_043_local_model_scorecard/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_043_local_model_scorecard
docker compose run --rm dev agentic quality-gate --story story_043_local_model_scorecard
```
