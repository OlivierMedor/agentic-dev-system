...
`story_010_cloud_review_packet` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_010_cloud_review_packet/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_010_cloud_review_packet
docker compose run --rm dev agentic quality-gate --story story_010_cloud_review_packet
```
