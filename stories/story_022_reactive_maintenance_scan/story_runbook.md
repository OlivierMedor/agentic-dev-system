...
`story_022_reactive_maintenance_scan` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_022_reactive_maintenance_scan/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_022_reactive_maintenance_scan
docker compose run --rm dev agentic quality-gate --story story_022_reactive_maintenance_scan
```
