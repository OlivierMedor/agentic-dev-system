...
`story_033_public_readiness_private_instructions` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_033_public_readiness_private_instructions/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_033_public_readiness_private_instructions
docker compose run --rm dev agentic quality-gate --story story_033_public_readiness_private_instructions
```
