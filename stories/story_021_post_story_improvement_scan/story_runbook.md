...
`story_021_post_story_improvement_scan` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_021_post_story_improvement_scan/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_021_post_story_improvement_scan
docker compose run --rm dev agentic quality-gate --story story_021_post_story_improvement_scan
```
