...
`story_015_mock_e2e_workflow_test` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_015_mock_e2e_workflow_test/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_015_mock_e2e_workflow_test
docker compose run --rm dev agentic quality-gate --story story_015_mock_e2e_workflow_test
```
