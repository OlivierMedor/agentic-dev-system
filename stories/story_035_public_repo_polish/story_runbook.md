...
`story_035_public_repo_polish` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_035_public_repo_polish/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_035_public_repo_polish
docker compose run --rm dev agentic quality-gate --story story_035_public_repo_polish
```
