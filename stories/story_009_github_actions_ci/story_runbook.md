...
`story_009_github_actions_ci` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_009_github_actions_ci/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_009_github_actions_ci
docker compose run --rm dev agentic quality-gate --story story_009_github_actions_ci
```
