...
`story_042_local_model_runtime_adapter` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_042_local_model_runtime_adapter/prompt_pack`.
...
docker compose run --rm dev agentic quality-gate --story story_042_local_model_runtime_adapter
```
