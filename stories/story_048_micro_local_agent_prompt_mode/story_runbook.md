...
`story_048_micro_local_agent_prompt_mode` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_048_micro_local_agent_prompt_mode/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_048_micro_local_agent_prompt_mode
docker compose run --rm dev agentic quality-gate --story story_048_micro_local_agent_prompt_mode
```
