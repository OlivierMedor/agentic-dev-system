...
The system already prepares role-specific work, but Story 060 makes local-model execution the first-class local automation path for blueprint-selected roles.
