...
`story_032_golden_path_operator_guide` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_032_golden_path_operator_guide/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_032_golden_path_operator_guide
docker compose run --rm dev agentic quality-gate --story story_032_golden_path_operator_guide
```
