...
- Evidence or reason: Add docs tests confirming the golden path guide exists, references required commands, and is linked from README.
...
- Evidence or reason: Existing CLI and workflow tests cover command behavior; this story changes documentation only.
...
- Evidence or reason: This documentation story does not call live external APIs.
...
- Evidence or reason: This documentation story does not deploy to a remote dev environment.
