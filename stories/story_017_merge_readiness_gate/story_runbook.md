...
`story_017_merge_readiness_gate` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_017_merge_readiness_gate/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_017_merge_readiness_gate
docker compose run --rm dev agentic quality-gate --story story_017_merge_readiness_gate
```
