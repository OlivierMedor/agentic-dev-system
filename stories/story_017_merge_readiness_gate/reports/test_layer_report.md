...
- Evidence or reason: Add unit tests for merge readiness status decisions and missing evidence handling.
...
- Evidence or reason: Existing command tests cover project command integration.
