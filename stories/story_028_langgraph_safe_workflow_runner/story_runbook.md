...
`story_028_langgraph_safe_workflow_runner` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_028_langgraph_safe_workflow_runner/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_028_langgraph_safe_workflow_runner
docker compose run --rm dev agentic quality-gate --story story_028_langgraph_safe_workflow_runner
```
