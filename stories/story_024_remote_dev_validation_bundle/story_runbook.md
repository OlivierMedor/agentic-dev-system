...
`story_024_remote_dev_validation_bundle` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_024_remote_dev_validation_bundle/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_024_remote_dev_validation_bundle
docker compose run --rm dev agentic quality-gate --story story_024_remote_dev_validation_bundle
```
