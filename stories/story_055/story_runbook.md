...
`story_055` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_055/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_055
docker compose run --rm dev agentic quality-gate --story story_055
```
