...
- test-layers: `agentic test-layers --project /app --story story_059` - Validate the story test layer plan.
- finalize-story: `agentic finalize-story --project /app --story story_059` - Refresh final local evidence and update story status.
- review-bundle: `agentic review-bundle --project /app --story story_059` - Refresh the local review bundle.
- workflow-preview: `agentic workflow-preview --project /app --story story_059` - Refresh the LangGraph route preview report.
...
- test-layers: PASSED (exit 0)
  - command: `agentic test-layers --project /app --story story_059`
  - summary: test-layers status: PASSED
  - result: `/app/stories/story_059/reports/test_layer_result.yaml`
  - report: `/app/stories/story_059/reports/test_layer_report.md`
- finalize-story: PASSED (exit 0)
  - command: `agentic finalize-story --project /app --story story_059`
  - summary: finalize-story status: ready_for_review
  - result: `/app/stories/story_059/reports/finalize_story_result.yaml`
  - report: `/app/stories/story_059/reports/finalize_story_report.md`
- review-bundle: PASSED (exit 0)
  - command: `agentic review-bundle --project /app --story story_059`
