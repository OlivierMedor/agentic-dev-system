...
`story_054_codex_first_tiered_runtime_defaults` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_054_codex_first_tiered_runtime_defaults/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_054_codex_first_tiered_runtime_defaults
docker compose run --rm dev agentic quality-gate --story story_054_codex_first_tiered_runtime_defaults
```
