...
- reports/codex_task_report.md
- reports/codex_task_result.yaml
- reports/codex_tasks
...
agentic record-cloud-review --story story_054_codex_first_tiered_runtime_defaults --result-file <path>
