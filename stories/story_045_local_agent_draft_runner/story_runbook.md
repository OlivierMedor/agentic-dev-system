...
`story_045_local_agent_draft_runner` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_045_local_agent_draft_runner/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_045_local_agent_draft_runner
docker compose run --rm dev agentic quality-gate --story story_045_local_agent_draft_runner
```
