...
`story_047_local_agent_prompt_slimming` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_047_local_agent_prompt_slimming/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_047_local_agent_prompt_slimming
docker compose run --rm dev agentic quality-gate --story story_047_local_agent_prompt_slimming
```
