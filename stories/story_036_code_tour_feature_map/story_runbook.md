...
`story_036_code_tour_feature_map` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_036_code_tour_feature_map/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_036_code_tour_feature_map
docker compose run --rm dev agentic quality-gate --story story_036_code_tour_feature_map
```
