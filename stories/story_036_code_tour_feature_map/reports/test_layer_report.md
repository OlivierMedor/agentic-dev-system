...
- Evidence or reason: Add docs tests confirming the code tour and command map exist, README links to them, command_map mentions key commands, and code_tour mentions required repository areas.
