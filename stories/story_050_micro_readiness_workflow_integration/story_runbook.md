...
`story_050_micro_readiness_workflow_integration` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_050_micro_readiness_workflow_integration/prompt_pack`.
...
docker compose run --rm dev agentic quality-gate --story story_050_micro_readiness_workflow_integration
```
