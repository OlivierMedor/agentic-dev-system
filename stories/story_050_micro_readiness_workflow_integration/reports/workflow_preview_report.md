...
- reports: developer_report.md, finalize_story_report.md, finalize_story_result.yaml, local_review_report.md, micro_readiness_report.md, micro_readiness_result.yaml, prepare_story_report.md, quality_gate_report.md, quality_gate_result.yaml, test_layer_report.md, test_layer_result.yaml, test_report.md, workflow_preview_report.md, workflow_preview_result.yaml, workflow_run_report.md, workflow_run_result.yaml
...
agentic record-cloud-review --story story_050_micro_readiness_workflow_integration --result-file <path>
