...
- Evidence or reason: Add release documentation tests verifying release process and checklist docs exist, CHANGELOG.md exists, README links to release docs, v0.1 checklist mentions required release checks, and release process requires human owner approval with no automatic deployment.
