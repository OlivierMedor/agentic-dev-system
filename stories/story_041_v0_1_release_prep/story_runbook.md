...
`story_041_v0_1_release_prep` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_041_v0_1_release_prep/prompt_pack`.
...
docker compose run --rm dev agentic quality-gate --story story_041_v0_1_release_prep
```
