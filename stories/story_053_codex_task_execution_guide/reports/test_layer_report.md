...
- Evidence or reason: Add deterministic docs tests for guide existence, README and codex runtime links, required command mentions, and safety language.
...
- Evidence or reason: This story changes documentation and doc presence tests only; no runtime command behavior changes.
...
- Evidence or reason: Existing workflow-run coverage exercises generated story workspaces; this story adds operator documentation only.
...
- Evidence or reason: The guide describes local files and commands only and does not require live services.
