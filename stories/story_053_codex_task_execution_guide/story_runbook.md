...
`story_053_codex_task_execution_guide` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_053_codex_task_execution_guide/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_053_codex_task_execution_guide
docker compose run --rm dev agentic quality-gate --story story_053_codex_task_execution_guide
```
