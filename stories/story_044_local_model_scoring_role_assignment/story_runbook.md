...
`story_044_local_model_scoring_role_assignment` is prepared for agent execution.
...
Prompt files are in `/app/stories/story_044_local_model_scoring_role_assignment/prompt_pack`.
...
docker compose run --rm dev agentic review-bundle --story story_044_local_model_scoring_role_assignment
docker compose run --rm dev agentic quality-gate --story story_044_local_model_scoring_role_assignment
```
