...
def test_public_readiness_blocks_other_runtime_artifacts() -> None:
    blocked_paths = [
        ...
        "stories/story_067/reports/local_execution_record.yaml",
        "stories/story_067/reports/local_review_decision.yaml",
        "stories/story_067/reports/quality_gate_result.yaml",
        "stories/story_067/reports/finalize_story_result.yaml",
